...
From the point of view on architect, this document provides an explanatin of what constitutes an information model for a data product, how it is represented and how the life cycle of it and its versions is managed.
